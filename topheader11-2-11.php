...
<table width="95%">
<tr>
<td class="left"><img src="images/logo_iner.jpg" border="0"/></td>
<td class="right">
	<table width="220">
		<tr>
		...
		<tr>
			<td><img src="images/help.png" width="16" height="16" border="0" alt=""></td>
			<td><LABEL onClick="OpenLink('support');" style="cursor:pointer;"><?php echo SUPPORT ;?></LABEL></td>
		  <td></td>
		</tr>
		<tr>
			<td colspan='3'>
