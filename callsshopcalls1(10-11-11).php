				...
				<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
				  <tr>
					<td>
						...
						<input type=\"button\" name=\"button\" id=\"button\" value=\"".CALLHISTORY."\" onclick=\"PopupCenter('callshis.php?id_client=".$data_new["id_client"]."', 'myPop1',900,400);\" style=\"float:left;margin-left:40px\"/>
						</form>
					</td>
					<td>
						...
						<input type=\"hidden\" name=\"usertype\" id=\"hiddenField\" value=\"".$usertype."\"/>
						<input type=\"hidden\" name=\"c_id\" id=\"hiddenField\" value=\"".$data_new["id_client"]."\"/>
						<input type=\"button\" name=\"button\" id=\"button\" value=\"".LASTCALL."\" onclick=\"PopupCenter('unpaidcalls.php?id_client=".$data_new["id_client"]."', 'myPop1',900,400);\" />
						</form>						
					</td>
