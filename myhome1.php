			...
			for(var ctrs=0;ctrs<8;ctrs++)
			{
				...
				{					
					...
					obj.oncountup=function(result,ctrs){								
						document.getElementById("cpcontainer"+ctrs).innerHTML="<span class=\'dcountstyle\'>"+result[\'days\']+":"+result[\'hours\']+":"+result[\'minutes\']+":"+result[\'seconds\']+"</span>";
					}
