...
$id_client = $_SESSION['id_callshop'];

$query = "SELECT * FROM tariffs WHERE id_tariff IN (SELECT id_tariff FROM clientse164 c WHERE id_client = 1305)";
$result = execute($query,1);
$totalRecords = mysql_num_rows($result);

$n->set($page,$limit,$totalRecords);

$query2 = "SELECT * FROM tariffs WHERE id_tariff IN (SELECT id_tariff FROM clientse164 c WHERE id_client = 1305) LIMIT ".$n->sql()."";
